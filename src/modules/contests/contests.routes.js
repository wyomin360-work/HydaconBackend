...
// ─── Admin ────────────────────────────────────────────────────────────────────
router.post(paths.adminCreate, verification.verifyAdmin, handleError(controller.adminCreateContest));
router.patch(paths.adminUpdate, verification.verifyAdmin, handleError(controller.adminUpdateContest));
router.delete(paths.adminDelete, verification.verifyAdmin, handleError(controller.adminDeleteContest));
router.get(paths.adminList, verification.verifyAdmin, handleError(controller.adminListContests));
router.get(paths.adminDetails, verification.verifyAdmin, handleError(controller.adminGetContestDetails));
router.post(paths.adminFinalise, verification.verifyAdmin, handleError(controller.adminFinaliseContest));
