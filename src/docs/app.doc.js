                ...
                properties: {
                  appConfig: {
                    ...
                    properties: {
                      ...
                      maintenanceMessage: {
                        type: "string",
                        example: "Maintenance at 2 AM",
                      },
                      androidUpdateUrl: {
                        type: "string",
                        example:
                          "https://play.google.com/store/apps/details?id=com.hydacon",
                      },
                      iosUpdateUrl: {
                        type: "string",
                        example:
                          "https://apps.apple.com/app/hydacon-app/id1234567890",
                      },
                      ...
                      updateNotes: {
                        ...
                        properties: {
                          ...
                          ios: {
                            type: "string",
                            example: "iOS compatibility updates.",
                          },
                        },
                      },
                      coinSettings: {
          ...
          "application/json": {
            schema: {
              ...
              properties: {
                ...
                maintenanceMessage: {
                  type: "string",
                  example: "Server maintenance on Friday night.",
                },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  message: {
                    type: "string",
                    example: "App configuration updated",
                  },
                  data: {
                    type: "object",
                    properties: {
