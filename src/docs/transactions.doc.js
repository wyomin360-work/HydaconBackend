                    ...
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                                properties: {
                                    message: { type: "string", example: "Withdraw request created" },
                                    data: {
                                        type: "object",
                                        properties: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                                properties: {
                                    message: { type: "string", example: "Transaction status updated" },
                                    data: {
                                        type: "object",
                                        properties: {
                                            transactionStatusUpdated: { type: "boolean", example: true }
                                        }
                                    }
                                }
                            }
