...
const sampleData = [
  ...
  },
  {
    ...
    images: {
      ...
      thumbnail: "https://images.unsplash.com/photo-1572916118970-fb5c8a1cb565?q=80&w=200&auto=format&fit=crop",
    },
  ...
  },
  {
    ...
    description: "The new season is here! Start earning points now to win amazing rewards.",
    type: "POPUP",
    popupType: "FULLSCREEN",
    ...
    images: {
      ...
      thumbnail: "https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?q=80&w=200&auto=format&fit=crop",
    },
    action: "OPEN_REWARDS",
    active: true,
    priority: 20,
  ...
  },
  {
    ...
    description: "Scan any product QR code this weekend to earn double loyalty points.",
    type: "CAMPAIGN",
    ...
    images: {
      ...
      thumbnail: "https://images.unsplash.com/photo-1517409095697-d8dcde0a9cf1?q=80&w=200&auto=format&fit=crop"
    },
    detailImages: [
  ...
  },
  {
    ...
    description: "Please note that the rewards catalog will be down for 2 hours this Saturday for upgrades.",
    type: "ANNOUNCEMENT",
